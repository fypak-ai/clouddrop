...
def transcode_file(filename):
    ...
    MKV/MP4/MOV/M4V: fast remux to fragmented MP4 (copy video, no re-encode).
    AVI/FLV/WMV/TS/etc: transcode to WebM/VP9.
    """
